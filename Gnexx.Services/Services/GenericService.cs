...
namespace Gnexx.Services.Services
{
        ...
        public class GenericService<SaveViewModel, ViewModel, Model> : IGenericService<SaveViewModel, ViewModel> 
             ...
             where Model : class
        {
            ...
            public GenericService(IRepository<Model> repository, IMapper mapper)
            {
